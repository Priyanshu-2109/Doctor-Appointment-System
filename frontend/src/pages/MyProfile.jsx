...
const MyProfile = () => {
  ...
  const [userData,setUserData] = useState({
    ...
    email:'zeelbarvaliya19@gmail.com',
    phone:'9925842422',
    address:{
      line1:"75 , Tulsishyam Soc. , Shyamdham Chowk",
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
        ...
        {
          isEdit
          ? <input className='bg-gray-50 text-3xl font-medium max-w-60 mt-4' type="text" value={userData.name} onChange={e => setUserData(prev => ({...prev,name:e.target}))} />
            ...
            <p className='font-medium'>Phone:</p>
              {
                ...
                : <p className='text-blue-4 00'>{userData.phone}</p>
              }
